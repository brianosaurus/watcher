...
Changes since this stage last prepared inputs: CHANGE_SPEC.md, @CHANGE_PLAN.pre-review.md, ADVERSARIAL_REVIEW.md, package.json, pyproject.toml, requirements.txt, package-lock.json, @green-check.commands, @green-check.groups
